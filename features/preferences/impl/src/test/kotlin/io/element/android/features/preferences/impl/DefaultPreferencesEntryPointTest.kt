...
class DefaultPreferencesEntryPointTest {
    ...
    fun `test initial target to nav target mapping`() {
        ...
        assertThat(PreferencesEntryPoint.InitialTarget.LockScreenSettings.toNavTarget())
            .isEqualTo(PreferencesFlowNode.NavTarget.LockScreenSettings)
        assertThat(PreferencesEntryPoint.InitialTarget.AdvancedSettings.toNavTarget())
            .isEqualTo(PreferencesFlowNode.NavTarget.AdvancedSettings)
        assertThat(PreferencesEntryPoint.InitialTarget.BlockedUsers.toNavTarget())
            .isEqualTo(PreferencesFlowNode.NavTarget.BlockedUsers)
        assertThat(PreferencesEntryPoint.InitialTarget.SignOut.toNavTarget())
            .isEqualTo(PreferencesFlowNode.NavTarget.SignOut)
