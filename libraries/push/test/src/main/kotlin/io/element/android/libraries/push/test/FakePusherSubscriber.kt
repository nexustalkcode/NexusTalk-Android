...
class FakePusherSubscriber(
    private val registerPusherResult: (MatrixClient, String, String) -> Result<Unit> = { _, _, _ ->
        error("registerPusherResult should be provided in tests")
    },
    private val unregisterPusherResult: (MatrixClient, String, String) -> Result<Unit> = { _, _, _ ->
        error("unregisterPusherResult should be provided in tests")
    },
) : PusherSubscriber {
